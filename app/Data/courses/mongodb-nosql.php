...
db.products.updateOne({ _id: 1 }, { $set: { stock: 50 } })',
  ...
  6 => 
  array (
    'slug' => 'mongodb-nosql-produccion',
    'order' => 7,
    'title' => 'Patrones de producción y resiliencia',
    'level' => 'Producción',
    'minutes' => 35,
    'summary' => 'Patrones de producción y resiliencia — cierre avanzado de MongoDB & NoSQL.',
    'concepts' => 
    array (
      0 => 'production',
      1 => 'resilience',
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  7 => 
  array (
    'slug' => 'mongodb-nosql-operaciones',
    'order' => 8,
    'title' => 'Observabilidad, debugging y checklist de deploy',
    'level' => 'Avanzado',
    'minutes' => 35,
    'summary' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de MongoDB & NoSQL.',
    'concepts' => 
    array (
      0 => 'production',
      1 => 'resilience',
