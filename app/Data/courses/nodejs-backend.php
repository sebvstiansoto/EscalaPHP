...
app.listen(3000);',
  ...
  6 => 
  array (
    'slug' => 'nodejs-backend-produccion',
    'order' => 7,
    'title' => 'Patrones de producción y resiliencia',
    'level' => 'Producción',
    'minutes' => 35,
    'summary' => 'Patrones de producción y resiliencia — cierre avanzado de Node.js backend.',
    'concepts' => 
    array (
      0 => 'production',
      1 => 'resilience',
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  7 => 
  array (
    'slug' => 'nodejs-backend-operaciones',
    'order' => 8,
    'title' => 'Observabilidad, debugging y checklist de deploy',
    'level' => 'Avanzado',
    'minutes' => 35,
    'summary' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de Node.js backend.',
    'concepts' => 
    array (
      0 => 'production',
      1 => 'resilience',
