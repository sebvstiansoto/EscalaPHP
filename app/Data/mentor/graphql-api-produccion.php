...
return array (
  ...
  array (
    ...
    'body' => 'Patrones de producción y resiliencia — cierre avanzado de GraphQL. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '◈',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Patrones de producción y resiliencia — cierre avanzado de GraphQL. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **GraphQL**, esto aparece en code reviews, incidentes y entregas diarias. Patrones de producción y resiliencia — cierre avanzado de GraphQL. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
