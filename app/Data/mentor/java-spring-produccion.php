...
return array (
  ...
  array (
    ...
    'body' => 'Patrones de producción y resiliencia — cierre avanzado de Java & Spring Boot. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '☕',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Patrones de producción y resiliencia — cierre avanzado de Java & Spring Boot. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Java & Spring Boot**, esto aparece en code reviews, incidentes y entregas diarias. Patrones de producción y resiliencia — cierre avanzado de Java & Spring Boot. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
