...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de OpenAPI & Swagger. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '📋',
  ),
  1 => 
  array (
...
spec:
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de OpenAPI & Swagger. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **OpenAPI & Swagger**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de OpenAPI & Swagger. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
