...
return array (
  ...
  array (
    ...
    'body' => 'Performance, bundle y Core Web Vitals — cierre avanzado de Astro. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🚀',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Performance, bundle y Core Web Vitals — cierre avanzado de Astro. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Astro**, esto aparece en code reviews, incidentes y entregas diarias. Performance, bundle y Core Web Vitals — cierre avanzado de Astro. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
