...
return array (
  ...
  array (
    ...
    'body' => 'Alta disponibilidad y recuperación ante fallos — cierre avanzado de Nginx y reverse proxy. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🌐',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'body' => 'Aplica lo aprendido en Nginx y reverse proxy a un entorno real: límites, fallos parciales, idempotencia y métricas que importan en producción.',
...
spec:
  ...
  array (
    ...
    'body' => '**Objetivo:** Alta disponibilidad y recuperación ante fallos — cierre avanzado de Nginx y reverse proxy. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Nginx y reverse proxy**, esto aparece en code reviews, incidentes y entregas diarias. Alta disponibilidad y recuperación ante fallos — cierre avanzado de Nginx y reverse proxy. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
