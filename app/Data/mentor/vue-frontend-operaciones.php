...
return array (
  ...
  array (
    ...
    'body' => 'Accesibilidad, SEO y checklist de release — cierre avanzado de Vue.js 3. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '💚',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Accesibilidad, SEO y checklist de release — cierre avanzado de Vue.js 3. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Vue.js 3**, esto aparece en code reviews, incidentes y entregas diarias. Accesibilidad, SEO y checklist de release — cierre avanzado de Vue.js 3. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
