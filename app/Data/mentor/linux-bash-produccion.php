...
return array (
  ...
  array (
    ...
    'body' => 'Buenas prácticas avanzadas en producción — cierre avanzado de Linux & Bash. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🐧',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Buenas prácticas avanzadas en producción — cierre avanzado de Linux & Bash. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Linux & Bash**, esto aparece en code reviews, incidentes y entregas diarias. Buenas prácticas avanzadas en producción — cierre avanzado de Linux & Bash. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
