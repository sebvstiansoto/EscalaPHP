...
return array (
  ...
  array (
    ...
    'body' => 'Patrones de producción y resiliencia — cierre avanzado de WordPress dev. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '📝',
  ),
  1 => 
  array (
...
$checks = [
  ...
  array (
    ...
    'body' => '**Objetivo:** Patrones de producción y resiliencia — cierre avanzado de WordPress dev. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **WordPress dev**, esto aparece en code reviews, incidentes y entregas diarias. Patrones de producción y resiliencia — cierre avanzado de WordPress dev. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
