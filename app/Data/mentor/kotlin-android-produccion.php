...
return array (
  ...
  array (
    ...
    'body' => 'Publicación en stores y CI mobile — cierre avanzado de Kotlin & Android. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🤖',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Publicación en stores y CI mobile — cierre avanzado de Kotlin & Android. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Kotlin & Android**, esto aparece en code reviews, incidentes y entregas diarias. Publicación en stores y CI mobile — cierre avanzado de Kotlin & Android. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
