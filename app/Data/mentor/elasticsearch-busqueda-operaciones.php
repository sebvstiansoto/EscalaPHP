...
return array (
  ...
  array (
    ...
    'body' => 'Calidad de datos, pipelines y alertas — cierre avanzado de Elasticsearch. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🔍',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Calidad de datos, pipelines y alertas — cierre avanzado de Elasticsearch. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Elasticsearch**, esto aparece en code reviews, incidentes y entregas diarias. Calidad de datos, pipelines y alertas — cierre avanzado de Elasticsearch. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
