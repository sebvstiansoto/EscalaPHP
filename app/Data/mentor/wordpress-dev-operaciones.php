...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de WordPress dev. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '📝',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'body' => 'Aplica lo aprendido en WordPress dev a un entorno real: límites, fallos parciales, idempotencia y métricas que importan en producción.',
    'code' => '<?php
declare(strict_types=1);

// Checklist post-deploy — wordpress-dev
$checks = [
...
$checks = [
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de WordPress dev. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **WordPress dev**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de WordPress dev. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
...
$checks = [
  ...
  array (
    ...
    array (
      ...
      2 => '// Checklist post-deploy — wordpress-dev',
      3 => '$checks = [',
