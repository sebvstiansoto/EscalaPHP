...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de Go backend. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🐹',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de Go backend. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Go backend**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de Go backend. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
