...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de Stripe & pagos. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '💳',
  ),
  1 => 
  array (
...
$checks = [
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de Stripe & pagos. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Stripe & pagos**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de Stripe & pagos. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
...
$checks = [
  ...
  array (
    ...
    array (
      ...
      2 => '// Checklist post-deploy — stripe-pagos',
      3 => '$checks = [',
