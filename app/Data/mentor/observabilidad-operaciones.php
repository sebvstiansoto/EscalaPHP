...
return array (
  ...
  array (
    ...
    'body' => 'Calidad de datos, pipelines y alertas — cierre avanzado de Observabilidad. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '📈',
  ),
  1 => 
  array (
    ...
    'body' => 'Antes de practicar, ubica estos términos en el glosario: [scale](/glosario#scale) · [cost](/glosario#cost) · [Pipeline](/glosario#pipeline)',
  ),
  2 => 
  array (
    'type' => 'teach',
...
spec:
  ...
  array (
    ...
    'body' => '**Objetivo:** Calidad de datos, pipelines y alertas — cierre avanzado de Observabilidad. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Observabilidad**, esto aparece en code reviews, incidentes y entregas diarias. Calidad de datos, pipelines y alertas — cierre avanzado de Observabilidad. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
