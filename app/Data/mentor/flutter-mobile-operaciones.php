...
return array (
  ...
  array (
    ...
    'body' => 'Performance, crashes y monitoreo en producción — cierre avanzado de Flutter. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🦋',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Performance, crashes y monitoreo en producción — cierre avanzado de Flutter. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Flutter**, esto aparece en code reviews, incidentes y entregas diarias. Performance, crashes y monitoreo en producción — cierre avanzado de Flutter. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
