...
return array (
  ...
  array (
    ...
    'body' => 'Estrategia y checklist del examen — cierre avanzado de Cert CKA. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '☸️',
  ),
  1 => 
  array (
...
spec:
  ...
  array (
    ...
    'body' => '**Objetivo:** Estrategia y checklist del examen — cierre avanzado de Cert CKA. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Cert CKA**, esto aparece en code reviews, incidentes y entregas diarias. Estrategia y checklist del examen — cierre avanzado de Cert CKA. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
