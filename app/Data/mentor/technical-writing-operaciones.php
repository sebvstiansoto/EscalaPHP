...
return array (
  ...
  array (
    ...
    'body' => 'Checklist profesional y próximos pasos — cierre avanzado de Technical writing. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '✍️',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Checklist profesional y próximos pasos — cierre avanzado de Technical writing. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Technical writing**, esto aparece en code reviews, incidentes y entregas diarias. Checklist profesional y próximos pasos — cierre avanzado de Technical writing. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
