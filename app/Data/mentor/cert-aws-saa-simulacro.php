...
return array (
  ...
  array (
    ...
    'body' => 'Simulacro de preguntas clave — cierre avanzado de Cert AWS SAA-C03. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🎓',
  ),
  1 => 
  array (
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Simulacro de preguntas clave — cierre avanzado de Cert AWS SAA-C03. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Cert AWS SAA-C03**, esto aparece en code reviews, incidentes y entregas diarias. Simulacro de preguntas clave — cierre avanzado de Cert AWS SAA-C03. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
