...
return array (
  ...
  array (
    ...
    'body' => 'Buenas prácticas avanzadas en producción — cierre avanzado de Ethical hacking. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🎯',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'body' => 'Aplica lo aprendido en Ethical hacking a un entorno real: límites, fallos parciales, idempotencia y métricas que importan en producción.',
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Buenas prácticas avanzadas en producción — cierre avanzado de Ethical hacking. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
    'title' => 'Vocabulario',
    'body' => 'Términos de esta lección: **best-practices**, **checklist**, **career**. Búscalos en el [/glosario](/glosario) si necesitas repaso.',
  ),
  6 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Ethical hacking**, esto aparece en code reviews, incidentes y entregas diarias. Buenas prácticas avanzadas en producción — cierre avanzado de Ethical hacking. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
