...
return array (
  ...
  array (
    ...
    'body' => 'Buenas prácticas avanzadas en producción — cierre avanzado de Clean Code. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '✨',
  ),
  1 => 
  array (
...
$checks = [
  ...
  array (
    ...
    'body' => '**Objetivo:** Buenas prácticas avanzadas en producción — cierre avanzado de Clean Code. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Clean Code**, esto aparece en code reviews, incidentes y entregas diarias. Buenas prácticas avanzadas en producción — cierre avanzado de Clean Code. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
...
$checks = [
  ...
  array (
    ...
    array (
      ...
      2 => '// Checklist post-deploy — clean-code',
      3 => '$checks = [',
