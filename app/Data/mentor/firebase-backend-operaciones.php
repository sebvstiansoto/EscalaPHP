...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de Firebase. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🔥',
  ),
  1 => 
  array (
...
logger.info({ route: \'/api/users\', ms: 42 }, \'request completed\');',
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de Firebase. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Firebase**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de Firebase. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
