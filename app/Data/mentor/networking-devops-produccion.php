...
return array (
  ...
  array (
    ...
    'body' => 'Alta disponibilidad y recuperación ante fallos — cierre avanzado de Networking para devs. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🌐',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'body' => 'Aplica lo aprendido en Networking para devs a un entorno real: límites, fallos parciales, idempotencia y métricas que importan en producción.',
...
kubectl rollout status deployment/api -n production --timeout=120s',
  ...
  array (
    ...
    'body' => '**Objetivo:** Alta disponibilidad y recuperación ante fallos — cierre avanzado de Networking para devs. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **Networking para devs**, esto aparece en code reviews, incidentes y entregas diarias. Alta disponibilidad y recuperación ante fallos — cierre avanzado de Networking para devs. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
