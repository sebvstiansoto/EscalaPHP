...
return array (
  ...
  array (
    ...
    'body' => 'Runbooks, SLOs y operación en producción — cierre avanzado de CI/CD & GitHub Actions. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '🔄',
  ),
  1 => 
  array (
...
spec:
  ...
  array (
    ...
    'body' => '**Objetivo:** Runbooks, SLOs y operación en producción — cierre avanzado de CI/CD & GitHub Actions. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'mentor_say',
    'title' => 'En el mundo real',
    'body' => 'En equipos que usan **CI/CD & GitHub Actions**, esto aparece en code reviews, incidentes y entregas diarias. Runbooks, SLOs y operación en producción — cierre avanzado de CI/CD & GitHub Actions. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  6 => 
  array (
