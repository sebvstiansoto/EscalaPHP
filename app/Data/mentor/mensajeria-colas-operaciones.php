...
return array (
  ...
  array (
    ...
    'body' => 'Observabilidad, debugging y checklist de deploy — cierre avanzado de Mensajería y colas. Te guío paso a paso con teoría, práctica y validación.',
    'emoji' => '📨',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'body' => 'Aplica lo aprendido en Mensajería y colas a un entorno real: límites, fallos parciales, idempotencia y métricas que importan en producción.',
    'code' => '<?php
declare(strict_types=1);

// Checklist post-deploy — mensajeria-colas
$checks = [
...
$checks = [
  ...
  array (
    ...
    'body' => '**Objetivo:** Observabilidad, debugging y checklist de deploy — cierre avanzado de Mensajería y colas. Al terminar este módulo deberías poder explicarlo a un compañero sin leer apuntes.',
  ),
  5 => 
  array (
    'type' => 'teach',
  ...
  array (
    ...
    'body' => 'En equipos que usan **Mensajería y colas**, esto aparece en code reviews, incidentes y entregas diarias. Observabilidad, debugging y checklist de deploy — cierre avanzado de Mensajería y colas. — no es teoría de manual: es lo que te van a pedir en producción.',
    'emoji' => '💼',
  ),
  7 => 
  array (
...
$checks = [
  ...
  array (
    ...
    array (
      ...
      2 => '// Checklist post-deploy — mensajeria-colas',
      3 => '$checks = [',
